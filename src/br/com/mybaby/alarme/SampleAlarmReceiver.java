...
public class SampleAlarmReceiver extends WakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {   
    	...
    	if(intent.getStringExtra(Constantes.ALARME_ALERTAS)!=null){
    		service = new Intent(context, SampleSchedulingService.class);
    	} else if(intent.getStringExtra(Constantes.ALARME_CONNECT)!=null){
     ...
     * @param context
     */
    public void setAlarm(Context context, String alarme, String tempo) {
    	alarmMgr = (AlarmManager)context.getSystemService(Context.ALARM_SERVICE);

    	if(alarme.equals(Constantes.ALARME_ALERTAS)){

    		Intent intent = new Intent(context, SampleAlarmReceiver.class);
    		intent.putExtra(Constantes.ALARME_ALERTAS, Constantes.ALARME_ALERTAS);
    		...
    		//alarmMgr.setInexactRepeating(AlarmManager.ELAPSED_REALTIME_WAKEUP, 1000, 1000, alarmIntent);

    		//ALARME PARA IMEDIATO
    	...
    	if(alarme.equals(Constantes.ALARME_CONNECT)){
    		alarmMgr = (AlarmManager)context.getSystemService(Context.ALARM_SERVICE);
    		Intent intent = new Intent(context, SampleAlarmReceiver.class);
